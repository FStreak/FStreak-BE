...
namespace FStreak.Infrastructure.Migrations
{
    ...
    [Migration("20251126133352_ChangeMetadataJsonToImage")]
    partial class ChangeMetadataJsonToImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.ShopItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.ShopOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.ShopOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.ShopOrderItem", b =>
                {
                    b.HasOne("FStreak.Domain.Entities.ShopOrder", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FStreak.Domain.Entities.ShopItem", "ShopItem")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("FStreak.Domain.Entities.UserAchievement", b =>
                {
                    b.HasOne("FStreak.Domain.Entities.Achievement", "Achievement")
